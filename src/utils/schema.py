...
def get_met_objects_schema():
    schema = StructType(
        [
            ...
            StructField(
                name="Artist Display Name", dataType=StringType(), nullable=True
            ),
            StructField(
                name="Artist Display Bio", dataType=StringType(), nullable=True
            ),
            ...
            StructField(
                name="Artist Nationality", dataType=StringType(), nullable=True
            ),
            StructField(
                name="Artist Begin Date", dataType=StringType(), nullable=True
            ),  # Might be converted to DateType
            StructField(
                name="Artist End Date", dataType=StringType(), nullable=True
            ),  # Might be converted to DateType
            ...
            StructField(
                name="Artist Wikidata URL", dataType=StringType(), nullable=True
            ),
            StructField(name="Object Date", dataType=StringType(), nullable=True),
            StructField(
                name="Object Begin Date", dataType=StringType(), nullable=True
            ),  # Might be converted to DateType
            StructField(
                name="Object End Date", dataType=StringType(), nullable=True
            ),  # Might be converted to DateType
            ...
            StructField(
                name="Rights and Reproduction", dataType=StringType(), nullable=True
            ),
            StructField(name="Link Resource", dataType=StringType(), nullable=True),
            StructField(
                name="Object Wikidata URL", dataType=StringType(), nullable=True
            ),
