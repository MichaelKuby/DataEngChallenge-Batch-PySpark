...
class TestBackwardFill(unittest.TestCase):
    def setUp(self):
        ...
        self.df_bw_fill_expected = self.spark.createDataFrame(self.expected_backward_fill_data, self.columns)
        ...
        self.df_fw_fill_expected = self.spark.createDataFrame(self.expected_forward_fill_data, self.columns)
        ...
        self.df_bw_and_fw_fill_expected = self.spark.createDataFrame(self.df_bw_and_fw_fill_data, self.columns)
